...
class _HomeScreenState extends State<HomeScreen> {
  ...
  DateTime dateTime = DateTime.parse('1969-07-20 20:18:04');
      ...
      children: [
        ...
        Row(
          children: [
            ...
            AnalogClock.dark(
              digitalClockColor: Colors.red,
              hourHandColor: Colors.green,
              minuteHandColor: Colors.purpleAccent,
              showAllNumbers: true,
              showSecondHand: true,
              showTicks: true,
              tickColor: Colors.amber,
              textScaleFactor: 1.5,
              numberColor: Colors.white,
              showNumbers: true,
              showDigitalClock: true,
              useMilitaryTime: true,
              secondHandColor: Colors.deepPurple,
              width: 320,
              height: 320,
              isLive: true,
              datetime: dateTimee,
